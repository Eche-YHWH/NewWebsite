...
export default function Footer() {
  return (
    <footer id="contact" className="relative py-14">
      {/* sky background behind footer */}
      <div
        aria-hidden="true"
      ...
      <Container>
        ...
        >
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="mt-6 space-y-2 text-sm text-black/70">
                ...
                <div className="flex gap-3">
                  ...
                  <a
                    ...
                    href="mailto:support@daashapp.co"
                  >
                    support@daashapp.co
                  </a>
                </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-black/60">
                ...
                <li>
                  <a className="transition hover:text-black" href="#benefits">
                    Benefits
                  </a>
                </li>
                <li>
          ...
          <div className="mt-10 border-t border-black/10 pt-6">
            <div className="flex flex-col gap-3 text-sm text-black/50 sm:flex-row sm:items-center sm:justify-between">
